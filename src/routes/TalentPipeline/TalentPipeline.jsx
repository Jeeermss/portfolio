...
const TalentPipeline = ({ scrollPosition }) => {
  return (
    <div className="talent-pipeline">
      ...
      <div className="page-section" data-section-label="Opportunity">
        ...
        >
          <Grid item xs={12} md={6} className="talent-pipeline__opportunity">
            ...
            <p>
              Build Your Future then built a partnership with Futures to launch
              a product that assists to these three different user types (see
              below).
            </p>
          </Grid>
          <Grid item xs={12} md={6} className="talent-pipeline__opportunity">
            ...
            <p>
              ...
              reported they proactively seek to build new talent, even if talent
        ...
        >
          ...
          <Grid item xs={12} md={6} className="talent-pipeline__personas">
            <p>
              ...
              insights from the GenZ target audience, which were in the process
              of completing their craft training high school program.
            </p>
            <p>
        ...
        >
          ...
          <Grid item xs={12} md={6} className="talent-pipeline__personas">
            ...
            <p>
              ...
              pathway for each user type. This helped build business and user
              requirements.
            </p>
          </Grid>
        </Grid>
        ...
        >
          ...
          >
            ...
            <p>
              ...
              landing pages to present quick findings and potential
              opportunities of how our product can insert itself within the
      ...
      <div className="page-section" data-section-label="LP Whiteboard Session">
        <Grid
          container
          rowGap={{ xs: 4, md: 0 }}
          rowSpacing={3}
        ...
        >
          ...
          >
            <h4>
              With all of these ideas in mind, how do we bring it all together
              to shine light on the product’s features?
            </h4>
          </Grid>
          <Grid
            item
          ...
          >
            <p>
              I scheduled a brainstorm workshop session with the marketing team
              to collaborate on the messaging hierarchy and visual layout.
            </p>
          </Grid>
          <Grid item xs={12}>
            <ScrollAnimation
      ...
      <div className="page-section" data-section-label="LP Final Result">
        ...
        >
          ...
          >
            <p>
              This landing page starts off with the main tag line then entices
              the visitor to learn more about the product.
            </p>
            <p>
              We wanted to showcase a visual indicator that people can access
              the product using their phone or desktop.{' '}
            </p>
          </Grid>
          <Grid item xs={12}>
            <ScrollAnimation
        ...
        >
          ...
          >
            <p>
              ...
              created and designed a thorough web and mobile style guide to
              ensure the UI and branding stays consistent throughout the
              platform.
            </p>
            <p>
